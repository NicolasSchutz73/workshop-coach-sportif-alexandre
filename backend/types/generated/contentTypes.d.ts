...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Textes et liens sociaux affich\u00E9s dans le pied de page';
  ...
  attributes: {
    ...
    colonnes: Schema.Attribute.Component<'partage.colonne-liens', true>;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: "Toutes les sections administrables de la page d'accueil";
  ...
  attributes: {
    aboutPreview: Schema.Attribute.Component<'homepage.about-preview', false>;
    benefits: Schema.Attribute.Component<'homepage.benefit', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faqs: Schema.Attribute.Component<'homepage.faq', true>;
    finalCta: Schema.Attribute.Component<'homepage.final-cta', false>;
    hero: Schema.Attribute.Component<'homepage.hero', false>;
    internalName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<"Page d'accueil">;
    introductionFaq: Schema.Attribute.Component<
      'page-accueil.introduction-section',
      false
    >;
    introductionPrestations: Schema.Attribute.Component<
      'page-accueil.introduction-section',
      false
    >;
    introductionTemoignages: Schema.Attribute.Component<
      'page-accueil.introduction-section',
      false
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    temoignages: Schema.Attribute.Component<'page-accueil.temoignage', true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPageAProposPageAPropos extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    nomInterne: Schema.Attribute.String &
      Schema.Attribute.Required &
...
export interface ApiPageContactPageContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    nomInterne: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Page Contact'>;
    objectifsFormulaire: Schema.Attribute.Component<
...
export interface ApiPageReservationPageReservation
...
export interface ApiParametresSiteParametresSite
  ...
  info: {
    description: 'Identit\u00E9, navigation, r\u00E9f\u00E9rencement global et manifeste de l\u2019application';
  ...
  attributes: {
    boutonReservation: Schema.Attribute.Component<'shared.button', false> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descriptionApplication: Schema.Attribute.Text & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    modeleTitre: Schema.Attribute.String & Schema.Attribute.Required;
    navigation: Schema.Attribute.Component<'partage.lien', true> &
      Schema.Attribute.Required;
    nomApplication: Schema.Attribute.String & Schema.Attribute.Required;
    nomApplicationCourt: Schema.Attribute.String & Schema.Attribute.Required;
    nomInterne: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Param\u00E8tres du site'>;
    nomMarque: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    seoGlobal: Schema.Attribute.Component<'partage.seo', false> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiServicesPageServicesPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Sections \u00E9ditables de la page Prestations';
    displayName: 'Page Prestations';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    finalCta: Schema.Attribute.Component<'services-page.final-cta', false> &
      Schema.Attribute.Required;
    header: Schema.Attribute.Component<'services-page.page-header', false> &
      Schema.Attribute.Required;
    internalName: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Page Prestations'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    plansSection: Schema.Attribute.Component<
